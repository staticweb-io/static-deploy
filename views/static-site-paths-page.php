                ...
                <?php foreach ( $view['paginatorRecords'] as $paginator_id => $paginator_path ) : ?>
                    <tr>
                        <th scope="row" class="check-column">
                            <label class="screen-reader-text" for="cb-select-<?php echo (int) $paginator_id; ?>">
                                Select <?php echo esc_html( $paginator_path ); ?>
                            </label>
                            <input id="cb-select-<?php echo (int) $paginator_id; ?>" type="checkbox" name="id[]" value="<?php echo (int) $paginator_id; ?>">
