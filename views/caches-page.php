    ...
    <table class="widefat striped">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo esc_html( $detected_files_total ); ?> files in database</td>
                <td>
                    <form
            ...
            <tr>
                <td>Crawled Files</td>
                <td><?php echo esc_html( $crawled_files_total ); ?> URLs in database</td>
                <td>
                    <form
            ...
            <tr>
                ...
                <td><?php echo esc_html( $exported_site_file_count ); ?> files, using <?php echo esc_html( $exported_site_disk_space ); ?>
                    ...
                    <a href="file://<?php echo esc_url( \StaticDeploy\StaticSite::getPath() ); ?>" />Path</a>
            ...
            <tr>
                ...
                <td><?php echo esc_html( $processed_site_file_count ); ?> files, using <?php echo esc_html( $processed_site_disk_space ); ?>
                    ...
                    <a href="file://<?php echo esc_url( \StaticDeploy\ProcessedSite::getPath() ); ?>" />Path</a>
                </td>
                <td>
                    <form
